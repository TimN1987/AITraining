...
class TargetEnv:
    ...
    def __init__(self, ai_player: RLPlayer, single_enabled: bool = True, airstrike_enabled: bool = False, bombardment_enabled: bool = False, print_stats: bool = False):
        # Constants
        self.REWARD_WEIGHTS = {
            'perfect': 100,
            'invalid': -50,
    ...
    def run_episode(self):
        ...
        shot_type_map = ['single', 'airstrike_up_right', 'airstrike_down_Right', 'bombardment']
